		...
		<table width="100%">
			...
			<tr>
				...
				<td>
					...
					<input name="noSeries" type="text" value="<?php echo isset($_POST['noSeries']) ? $_POST['noSeries'] : $assetSeriesCodeSugest ?>" size="4" maxlength="4" />
					<small>Kode Asset Seri harus 4 digit</small>
			...
			<tr>
				...
				<td>
					<input name="noPurchase" type="text" value="<?php echo isset($_POST['noPurchase']) ? $_POST['noPurchase'] : ''?>"  />
				...
				<td>
					<select name="fundId">
						<?php while($val = mysql_fetch_array($dataFund)): ?>
							<option value="<?php echo $val['id'] ?>" <?php echo $val['id'] == (isset($_REQUEST['fundId']) ? $_REQUEST['fundId'] : '') ? 'selected' : '' ?>><?php echo $val['name'] ?></option>
						<?php endwhile; ?>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input name="priceBuy" type="text" value="<?php echo isset($_POST['priceBuy']) ? $_POST['priceBuy'] : ''?>"  size="7" />
			...
			<tr>
				...
				<td>
					<input name="price" type="text" value="<?php echo isset($_POST['price']) ? $_POST['price'] : ''?>"   size="7" />
			...
			<tr>
				...
				<td>
					<input name="priceMin" type="text" value="<?php echo isset($_POST['priceMin']) ? $_POST['priceMin'] : ''?>"   size="7" />
			...
			<tr>
				...
				<td>
					<input name="depriciation" type="text" value="<?php echo isset($_POST['depriciation']) ? $_POST['depriciation'] : ''?>"   size="7" />  / Tahun
					<div style="color:red"><?php echo isset($msgError['depriciation']) ? $msgError['depriciation'] : '' ?></div>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select name="condition" style="width:155px">
						<option value="0" <?php echo ($_POST['condition'] == '0') ? 'selected' : '' ?>>RUSAK</option>
						<option value="1" <?php echo ($_POST['condition'] == '1') ? 'selected' : '' ?>>BAIK</option>
						<option value="2" <?php echo ($_POST['condition'] == '2') ? 'selected' : '' ?>>SETENGAH BAIK</option>
					</select>
				</td>
			</tr>
			<tr>
