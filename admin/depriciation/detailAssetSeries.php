				...
				<tbody>
					...
					<?php while($row = mysql_fetch_array($data)): ?>	
						<tr>
							...
							<td align="center"><?php echo $row['asset_code'].'-'.$row['no_serries'] ?></td>
							<td align="center"><?php echo number_format($row['price_buy'], 0 , '' , '.')  ?></td>
							<td align="center"><?php echo number_format($row['price'], 0 , '' , '.')  ?></td>
							<td align="center"><?php echo number_format($row['price_min'], 0 , '' , '.')  ?></td>
							<td align="center"><?php echo number_format($row['depriciation'], 0 , '' , '.')  ?></td>
							<td align="center"><?php echo number_format($row['depriciation']/12, 0 , '' , '.')  ?>/bulan</td>
						</tr>
						<?php $i++ ?>
					<?php endwhile; ?>									
				<tbody>
