	...
	<fieldset>	
		...
		<table width="100%">
			<tr>
				...
				<td width="20%"><b>:<?php echo $dataInfo['year'] ?></b></td>
				<td width="15%" valign="top">Keterangan</td>
				<td rowspan="2"><b> <?php echo $dataInfo['description'] ?></b></td>
			</tr>
			<tr>
				<td>Eksekusi Penyusutan</td>
				<td><b>:<?php echo $dataInfo['date_name'] ?></b></td>
				<td></td>		
			</tr>
		</table>
	</fieldset>
													...
													<?php while($valAsset = mysql_fetch_array($dataAsset)): ?>
														<?php if($valAsset['jml'] > 0): ?>	
															<?php 
																...
																$dataAssetDepriciation = mysql_fetch_array($tmp);		
															?>	
															<tr>
																<td align="left">
																...
																<td align="center">
																	<div class="button">
																		<a   data-title="DETAIL PENYUSUTAN" data-width="750" data-height="550" href="detailAssetSeries.php?depriciationId=<?php echo $depriciationId ?>&assetId=<?php echo $valAsset['id'] ?>"><?php echo number_format($dataAssetDepriciation['jml'], 0 , '' , '.')  ?></a>															
																	</div>
