...
<?php else: ?>
	...
	<div id="tbl">
		<table width="100%" border="1">
			<thead>			
				<tr>					
					...
					<th align="center" width="25%">NOMOR SERI</th>							
					<th align="center" width="35%"><small>LOKASI / MERK /JUDUL</small></th>
			...
			<tbody>
				...
				<?php while($val = mysql_fetch_array($data)): ?>
					<tr>						
						...
						<td align="center">
							<small><b><?php echo $dataLocation[$val['location_id']] ?></b></small><br />
							<small><i><?php echo $val['merk'] ?></i></small>
						</td>	
						<td align="center">
							<?php if($val['cond'] == '0'): ?>
								RUSAK
		...
		<p style="text-align:center; padding:10px">
			<?php
				echo $split->splitPage($_GET['SplitLanjut'],array('dateBuy='.$dateBuy, 'assetId='.$_REQUEST['assetId'],'fundId='.$_REQUEST['fundId'],'departementId='.$_REQUEST['departementId'],'condition='.$_REQUEST['condition']));
				echo '<br /><br />';
