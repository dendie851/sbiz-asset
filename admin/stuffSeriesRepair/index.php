<?php ob_start(); ?>
	...
	<?php if(isset($_REQUEST['keyword'])): ?>
		...
		<?php else: ?>
				...
				<table width="100%" border="1">
					<thead>			
						<tr>
							...
							<th align="center" width="45%">NAMA ASSET</th>						
					...
					<tbody>
						...
						<?php while($val = mysql_fetch_array($data)): ?>
							<tr>
								...
								<td align="center">
									<div class="button">
										<a href="history.php?id=<?php echo $val['id'] ?>"  data-title="RIWAYAT PERBAIKAN" data-width="600" data-height="550">TAMPILKAN</a>
									</div>
								</td>	
							</tr>	
						<?php $i++; ?>
			...
			<hr />
			<fieldset>
				<legend><b>PERBAIKAN ASSET</b></legend>
					<div class="clear">
					<table width="100%">
						<tr>
							<td width="18%"><b>TGL PERBAIKAN</b></td>
							<td>
								<input style="width:110px" name="dateRepair" readonly id="dateRepair" type="text" value="" />																		
							</td>
						</tr>						
						<tr>
