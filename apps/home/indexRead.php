<?php 
	...
	$keyword = trim(str_replace('/','',str_replace('-','',$_REQUEST['keyword'])));
	
	$where .= " and concat((select code from asset as a where a.id = asset_series.asset_id and asset_series.is_delete = '0'),asset_series .no_serries)  = '$keyword' ";
