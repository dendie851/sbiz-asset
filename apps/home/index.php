...
<h1 align="align:center">
	<center>PUSAT INFORMASI ASSET</b></center>
</h1>
<br />
...
<?php if (isset($msgError['id']) && strlen($msgError['id']) > 0): ?>
	<div class="error">
			...
			<table width="70%" border="0">
				...
				<tr>
					<td colspan="2" align="center">
						<hr /><small>Silakan masukan no seri asset, <br />contoh: 00001-0002 atau 00001/0002 atau
							000010002</small>
					</td>
				</tr>
			</table>
...
<?php if (isset($_REQUEST['keyword'])): ?>
	...
	<?php else: ?>
		<form action="editSave.php" method="post">
			<input name="keyword" type="hidden" value="<?php echo isset($_REQUEST['keyword']) ? $_REQUEST['keyword'] : '' ?>"
				size="1" maxlength="4" />
			<input name="assetId" type="hidden" value="<?php echo isset($_REQUEST['id']) ? $_REQUEST['id'] : '' ?>" size="1"
				maxlength="4" />
			<div id="tbl">
						...
						<?php while ($val = mysqli_fetch_array($data)): ?>
							<tr>
								<td align="left" valign="top">
									<table width="100%" style="border: 0px">
											...
											<td style="border: 0px; padding:0px">
												<b>: <small>
														<?php if (strlen($val['foto']) > 0): ?>
															<a href="../admin/asset/foto/<?php echo $val['foto'] ?>" class="lightbox"
										...
										<tr>
											...
											<td style="border: 0px; padding:0px"><b>: <small><?php echo $val['no_purchase'] ?>
													</small></td></b>
										</tr>
									</table>
								</td>
									...
									<table width="100%" style="border: 0px">
										<tr>
											...
											<td style="border: 0px; padding:0px"><b>:
													<small><?php echo $val['location_name'] ?></small></b></td>
										</tr>
										<tr>
											<td style="border: 0px; padding:0px"><small>Sumber Dana</small></td>
											<td style="border: 0px; padding:0px"><b>:
													<small><?php echo $val['fund_name'] ?></small></b></td>
										</tr>
										<tr>
											<td width="18%" style="border: 0px; padding:0px"><small>Departemen</small></td>
											<td style="border: 0px; padding:0px"><b>:
													<small><?php echo $val['departement_name'] ?></small></b></td>
										</tr>
									</table>
								</td>
								<td align="center" valign="top">
									<table width="100%" style="border: 0px">
										...
										<tr>
											...
											<td style="border: 0px; padding:0px"><b>: <small><?php echo $val['merk'] ?></small></b>
											</td>
										</tr>
									</table>
								</td>
								<td align="center" valign="top">
									<table width="100%" style="border: 0px">
										<tr>
											...
											<td style="border: 0px; padding:0px">
												<b><small> :
														<?php echo number_format($val['price_buy'], 0, '', '.') ?></small></b>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td style="border: 0px; padding:0px">
												<b><small> :
														<?php echo number_format($val['price_min'], 0, '', '.') ?></small></b>
											</td>
										</tr>
										<tr>
											...
											<td style="border: 0px; padding:0px">
												<b><small> :
														<?php echo number_format($val['depriciation'], 0, '', '.') ?>/Tahun</small></b>
											</td>
										</tr>
									</table>
								</td>
								<td valign="top" align="center">
									...
									<div class="button">
										[<a href="history.php?id=<?php echo $val['id'] ?>" data-title="RIWAYAT ASSET"
											data-width="600" data-height="550">Riwayat Asset</a>]
									</div>
								</td>
							</tr>
						<?php endwhile; ?>
		...
		<?php else: ?>
			<div class="info">
				<h3>
					<center>Silakan masukan No Seri Asset</center>
				</h3>
			</div>
		<?php endif; ?>
