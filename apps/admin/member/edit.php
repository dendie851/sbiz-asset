	...
	<table width="100%">
		<tr>
			...
			<td>
				...
				<div style="color:red">
					<?php echo isset($msgError['name']) ? $msgError['name'] : '' ?>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<select name="positionId" style="width:155px">
					<?php while ($val = mysqli_fetch_array($dataPosition)): ?>
						<option value="<?php echo $val['id'] ?>" <?php echo $val['id'] == (isset($_REQUEST['positionId']) ? $_REQUEST['positionId'] : $data['position_id']) ? 'selected' : '' ?>>
							<?php echo $val['name'] ?>
						</option>
					<?php endwhile; ?>
				</select>
		...
		<tr>
			...
			<td>
				...
				<input name="username" type="text"
					value="<?php echo isset($_POST['username']) ? $_POST['username'] : $dataUser['username'] ?>" />
				<div style="color:red">
					<?php echo isset($msgError['username']) ? $msgError['username'] : '' ?>
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div style="color:red">
					<?php echo isset($msgError['pwd']) ? $msgError['pwd'] : '' ?>
				</div>
