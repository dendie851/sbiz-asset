<?php ob_start(); ?>
	...
	<table width="100%">
		<tr>
			<td align="right"><input type="button" value="KEMBALI >>" onclick="window.location='../stuffView/index.php'" /></td>
		</tr>	
	</table>
	<br />
							...
							<td align="left" valign="top">
								<table width="100%" style="border: 0px">
									<tr>
										...
										<td style="border: 0px; padding:0px"><b>: <small><?php echo $val['code'] ?></b>-<?php echo $val['no_serries'] ?> </small></b></td>														
									</tr>
									<tr>
