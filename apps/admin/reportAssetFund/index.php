		...
		<table width="100%">
			<tr>
				<td style="text-align:right">
					<input type="button"
						onclick="window.open('excel.php?locationId=<?php echo $_REQUEST['locationId'] ?>&fundId=<?php echo $_REQUEST['fundId'] ?>')"
						value="PRINT TO EXCEL">
					<input type="button"
						onclick="window.open('print.php?locationId=<?php echo $_REQUEST['locationId'] ?>&fundId=<?php echo $_REQUEST['fundId'] ?>')"
						value="PRINT">
				</td>
			</tr>
		</table>
											...
											<tr>
												...
												<td align="center">
													...
													<?php if ($resultFundJml['jumlah'] > 0): ?>
														<div class="button">
															<a href="detail.php?assetId=<?php echo $val['asset_id'] ?>&fundId=<?php echo $valFund['id'] ?>&locationId=<?php echo $val['location_id'] ?>"
																data-title="DETAIL" data-width="600"
																data-height="550"><?php echo $resultFundJml['jumlah'] ?></a>
														</div>
													<?php else: ?>
