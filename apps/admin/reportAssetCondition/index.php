												...
												<tr>
													...
													<td align="center">
														...
														<?php if ($dataJml['jumlah'] > 0): ?>
															<div class="button">
																<a href="detail.php?assetId=<?php echo $valAsset['id'] ?>&condId=1"
																	data-title="DETAIL" data-width="600"
																	data-height="550"><?php echo $dataJml['jumlah'] ?></a>
															</div>
														<?php else: ?>
													...
													<td align="center">
														...
														<?php if ($dataJml['jumlah'] > 0): ?>
															<div class="button">
																<a href="detail.php?assetId=<?php echo $valAsset['id'] ?>&condId=2"
																	data-title="DETAIL" data-width="600"
																	data-height="550"><?php echo $dataJml['jumlah'] ?></a>
															</div>
														<?php else: ?>
													...
													<td align="center">
														...
														<?php if ($dataJml['jumlah'] > 0): ?>
															<div class="button">
																<a href="detail.php?assetId=<?php echo $valAsset['id'] ?>&condId=0"
																	data-title="DETAIL" data-width="600"
																	data-height="550"><?php echo $dataJml['jumlah'] ?></a>
															</div>
														<?php else: ?>
