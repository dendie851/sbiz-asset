<?php ob_start(); ?>
				...
				<tr>
					<td rowspan="3" valign="top"  width="15%">
						<?php if(strlen($dataInfo['foto_thumb']) > 0 ): ?>
							<a href="../asset/foto/<?php echo $dataInfo['foto'] ?>" class="lightbox" title="<?php echo $dataInfo['name'] ?>">
					...
					<td width="20%" valign="top" >: <b><?php echo $dataInfo['category_name'] ?></b></td>		
					<td width="15%" valign="top">KODE</td>
					<td valign="top">: <b><?php echo $dataInfo['code'] ?></b></td>
				</tr>	
				<tr>
					<td valign="top">NAMA</td>
					<td valign="top">: <b><?php echo $dataInfo['name'] ?></b></td>
					<td valign="top">UKURAN</td>
					<td valign="top">: <b><?php echo $dataInfo['size'] ?></b></td>
				</tr>				
			</table>
		</form>
	</fieldset>
	...
	<table width="100%">
		<tr>
			<td><input type="button" value="TAMBAH" onclick="window.location='add.php?assetId=<?php echo $_REQUEST['id']?>'" /></td>
				...
				<tbody>
					...
					<?php while($val = mysqli_fetch_array($data)): ?>
						<tr>
							...
							<td align="left" valign="top">
								<table width="100%" style="border: 0px">
									<tr>
										...
										<p>No Seri</p>
										<b><?php echo $val['code'] ?></b></b>-<input style="width: 40px" name="noSeries[]" type="text" value="<?php echo $val['no_serries'] ?>" size="1" maxlength="4" /></td>
									</tr>
									<tr>										
							...
							<td align="center" valign="top">
								<table width="100%" style="border: 0px">
									<tr>
										<td width="28%" style="border: 0px; padding:0px">
										<p>Harga Beli</p>
											<input name="priceBuy[]" type="text" value="<?php echo $val['price_buy'] ?>" size="3" style="width:100px" />
									</tr>
									<tr>										
										<td style="border: 0px; padding:0px">
										<p>Harga Sekarang</p>
										<input name="price[]" type="text" value="<?php echo $val['price'] ?>" size="3" style="width:100px" />		
									</tr>									
									<tr>										
										<td style="border: 0px; padding:0px">
										<p>Harga Minimum</p>
							...
							<td align="center">
								<input type="button" value="HAPUS" onclick="confirm('Anda yakin akan menghapus ?') ? window.location='delete.php?id=<?php echo $val['id'] ?>&assetId=<?php echo $_REQUEST['id'] ?>' : false" />
							</td>
						</tr>	
					<?php $i++; ?>
					<?php endwhile; ?>
