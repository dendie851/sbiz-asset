...
<table width="100%">
	<tr>
		<td><input type="button" value="TAMBAH"
				onclick="window.location='add.php?assetId=<?php echo $_REQUEST['id'] ?>'" /></td>
		<td align="right"><input type="button" value="KEMBALI >>" onclick="window.location='../stuff/index.php'" /></td>
	</tr>
</table>
<br />
			...
			<table width="100%" border="1">
				<thead>
					<tr>
						...
						<th align="center" width="14%">NOMOR</th>
						...
						<tr>
								...
								<table width="100%" style="border: 0px">
									<tr>
										<td width="28%" style="border: 0px; padding:0px">
											...
											<b>
												<?php echo $val['code'] ?>
											</b></b>-<input style="width: 40px" name="noSeries[]" type="text"
												value="<?php echo $val['no_serries'] ?>" size="1" maxlength="5" />
										</td>
									</tr>
									<tr>
										<td style="border: 0px; padding:0px">
											<p>No Pembelian </p>
											<input style="width: 90px" name="noPurchase[]" type="text"
												value="<?php echo $val['no_purchase'] ?>" size="5" />
										</td>
									</tr>
								</table>
							</td>
										...
										<td width="28%" style="border: 0px; padding:0px">
											...
											<select name="locationId[]" style="width:200px">
												<?php foreach ($dataLocation as $valLocation): ?>
													<option value="<?php echo $valLocation['id'] ?>" <?php echo $valLocation['id'] == $val['location_id'] ? 'selected' : '' ?>>
														<?php echo $valLocation['name'] ?>
													</option>
												<?php endforeach; ?>
											</select>
									</tr>
										...
										<td style="border: 0px; padding:0px">
											...
											<select name="fundId[]" style="width:200px">
												<?php foreach ($dataFund as $valFund): ?>
													<option value="<?php echo $valFund['id'] ?>" <?php echo $valFund['id'] == $val['fund_id'] ? 'selected' : '' ?>>
										...
										<td style="border: 0px; padding:0px">
											...
											<select name="departementId[]" style="width:200px">
												<?php foreach ($dataDepartement as $valDepartement): ?>
													<option value="<?php echo $valDepartement['id'] ?>" <?php echo $valDepartement['id'] == $val['departement_id'] ? 'selected' : '' ?>>
														<?php echo $valDepartement['name'] ?>
													</option>
												<?php endforeach; ?>
											</select>
									</tr>
								...
								<table width="100%" style="border: 0px">
									<tr>
										<td width="28%" style="border: 0px; padding:0px" valign="top">
											...
											<select name="condition[]" style="width:150px">
												<option value="0" <?php echo ($val['cond'] == '0') ? 'selected' : '' ?>>RUSAK
												</option>
												<option value="1" <?php echo ($val['cond'] == '1') ? 'selected' : '' ?>>BAIK
												</option>
												<option value="2" <?php echo ($val['cond'] == '2') ? 'selected' : '' ?>>SETENGAH
													BAIK</option>
											</select>
										</td>
									</tr>
									<tr>
										<td style="border: 0px; padding:0px" valign="top">
											<p>Merk / Judul</p>
											<input name="merk[]" type="text" value="<?php echo $val['merk'] ?>" size="3"
												style="width:135px" />
									</tr>
								</table>
							</td>
							<td align="center" valign="top">
								<table width="100%" style="border: 0px">
									<tr>
										<td width="28%" style="border: 0px; padding:0px">
											<p>Harga Beli</p>
											<input name="priceBuy[]" type="text" value="<?php echo $val['price_buy'] ?>"
												size="3" style="width:100px" />
									</tr>
									<tr>
										<td style="border: 0px; padding:0px">
											<p>Harga Sekarang</p>
											<input name="price[]" type="text" value="<?php echo $val['price'] ?>" size="3"
												style="width:100px" />
									</tr>
									<tr>
										<td style="border: 0px; padding:0px">
											<p>Harga Minimum</p>
											<input name="priceMin[]" type="text" value="<?php echo $val['price_min'] ?>"
												size="3" style="width:80px" /> <small></small>
									</tr>
									<tr>
										<td style="border: 0px; padding:0px">
											<p>Nilai Penyusutan</p>
											<input name="depriciation[]" type="text" value="<?php echo $val['depriciation'] ?>"
												size="3" style="width:80px" /> <small>/ Tahun</small>
									</tr>
								</table>
							</td>
							<td valign="top" align="center">
								<br />
								<input style="width:80px" name="dateBuy[]" readonly id="dateBuy<?php echo $i ?>" type="text"
							...
							<td align="center">
								<input type="button" value="HAPUS"
									onclick="confirm('Anda yakin akan menghapus ?') ? window.location='delete.php?id=<?php echo $val['id'] ?>&assetId=<?php echo $_REQUEST['id'] ?>' : false" />
							</td>
						</tr>
						<?php $i++; ?>
					<?php endwhile; ?>
