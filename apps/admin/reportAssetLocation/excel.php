...
header("Content-Disposition: attachment; filename=LAPORAN-LOKASI-ASSET.xls");
?>
	...
	<form action="index.php" method="post">
		<table width="100%">
			<tr>
				...
				<td>
					<b>:
						<?php echo $locationId == 'x' ? 'SEMUA' : $dataLocation[$locationId] ?>
					</b>
				</td>
			</tr>
		</table>
							...
							<td align="left">
								...
								<small>
									<?php while ($valAssetSerires = mysqli_fetch_array($tmp)): ?>
										<?php echo $val['code'] ?>-
										<?php echo $valAssetSerires['no_serries'] ?>
										(
										<?php if ($valAssetSerires['cond'] == '0'): ?>R
										<?php endif; ?>
										<?php if ($valAssetSerires['cond'] == '1'): ?>B
										<?php endif; ?>
										<?php if ($valAssetSerires['cond'] == '2'): ?>SB
										<?php endif; ?>),
									<?php endwhile; ?>
								</small>
							</td>
