<?php ob_start(); ?>
	...
	<?php if(isset($_REQUEST['keyword'])): ?>
		...
		<?php else: ?>
				...
				<table width="100%" border="1">
					<thead>			
						<tr>
							...
							<th align="center" width="15%">NOMOR SERI</th>							
							<th align="center" width="30%">NAMA ASSET</th>						
							<th align="center" width="35%">LOKASI</th>
							<th align="center" width="12%">RIWAYAT</th>
						</tr>	
					</thead>
					<tbody>
						...
						<?php while($val = mysqli_fetch_array($data)): ?>
							<tr>
								...
								<td align="center">
									<div class="button">
										<a href="history.php?id=<?php echo $val['id'] ?>"  data-title="RIWAYAT PEMINDAHAN" data-width="600" data-height="550">TAMPILKAN</a>
									</div>
								</td>	
							</tr>	
						<?php $i++; ?>
			...
			<hr />
			<fieldset>
				<legend><b>PINDAHKAN KE LOKASI</b></legend>
					<div class="clear">
					<table width="100%">
						<tr>
							<td width="14%"><b>LOKASI</b></td>
							<td>
								<select name="locationId" style="width:245px">
									<?php foreach($dataLocationCmb as $val): ?>
										<option value="<?php echo $val['id'] ?>" <?php echo $val['id'] == (isset($_REQUEST['locationId']) ? $_REQUEST['locationId'] : '') ? 'selected' : '' ?>><?php echo $val['name'] ?></option>
									<?php endforeach; ?>
								</select>
							</td>
						</tr>	
						<tr>
							<td><b>TGL PINDAH</b></td>
							<td>
								<input style="width:110px" name="dateMove" readonly id="dateMove" type="text" value="" />																		
							</td>
						</tr>						
						<tr>
