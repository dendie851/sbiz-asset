	...
	<?php else: ?>
		<p style="text-align:right">
			<input type="button" value="PRINT"
				onclick="window.open('print.php?type=<?php echo $_REQUEST['type'] ?>&dateFrom=<?php echo urlencode($_REQUEST['dateFrom']) ?>&dateTo=<?php echo urlencode($_REQUEST['dateTo']) ?>')" />
			<input type="button" value="EXPORT KE EXCEL"
				onclick="window.open('excel.php?type=<?php echo $_REQUEST['type'] ?>&dateFrom=<?php echo urlencode($_REQUEST['dateFrom']) ?>&dateTo=<?php echo urlencode($_REQUEST['dateTo']) ?>')" />
		</p>
					...
					<tr>
						...
						<td align="center">
							<?php if (strlen($val['asset_foto_thumb']) > 0): ?>
								<a href="../asset/foto/<?php echo $val['asset_foto'] ?>" class="lightbox"
									title="<?php echo $val['asset_name'] ?>">
