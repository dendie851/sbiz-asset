	...
	<form action="editSave.php" method="post" enctype="multipart/form-data" >
		...
		<table width="100%">
			<tr>
				...
				<td>
					<input name="code" type="text" value="<?php echo isset($_POST['code']) ? $_POST['code'] : $data['code'] ?>" size="5" maxlength="5" />
			...
			<tr>
				...
				<td valign="top"  rowspan="2">
					<?php if(strlen($data['foto_thumb']) > 0 ): ?>
						<a href="../asset/foto/<?php echo $data['foto'] ?>" class="lightbox" title="<?php echo $data['name'] ?>">
